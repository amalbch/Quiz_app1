    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        questionsList = arrayListOf(
            QuestionModel(
                ...
                listOf("A flow of water", "A flow of air", "A flow of electrons", "A flow of atoms"),
                "A flow of electrons"
            ),
            QuestionModel(
                "What is the speed of sound?",
                listOf("120 km/h", "1,200 km/h", "400 km/h", "700 km/h"),
                "1,200 km/h"
            ),
            QuestionModel(
                "What is the main component of the sun?",
                listOf("Liquid lava", "Gas", "Molten iron", "Rock"),
                "Gas"
            ),
            QuestionModel(
                "Which of the following animals can run the fastest?",
                listOf("Cheetah", "Leopard", "Tiger", "Lion"),
                "Cheetah"
            ),
            QuestionModel(
                "Which company is known for publishing the Mario video game?",
                listOf("Xbox", "Nintendo", "SEGA", "Electronic Arts"),
                "Nintendo"
            )
        )
